...
def build_cnn(num_classes: int, image_dim: int = 32):
    ...
    plot_model(cnn_model, to_file='model_plot_true.png', show_shapes=True, show_layer_names=True)
    return cnn_model

def train_cnn(X_train, X_test, Y_train, Y_test, model, epochs=5, batch_size=100):
